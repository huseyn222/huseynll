...
namespace _19final.Areas.admin.Controllers
{
    public class teklifsController : Controller
    {
        ...
        // GET: admin/teklifs/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: admin/teklifs/Create
